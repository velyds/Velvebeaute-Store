...
<div class="card shadow mb-4">
    <div class="card-header py-3 mb-3">
            <h2 class="mb-2 text-center">Riwayat Belanja</h2>
        <div class="row">
        </div>
    </div>
    <div class="card-body">
        <table class="table table-bordered" id="">
            ...
            <tbody>
                ...
                $ambil = $koneksi->query("SELECT * FROM tb_purchase WHERE id_pelanggan = $id");
                foreach ($ambil as $pecah) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="me.php?page=transaksi&act=detail&id=<?php echo $pecah['id_pembelian']; ?>" class="btn btn-primary">Pembayaran</a>
                        </td>
                    </tr>
                    <?php $nomor++; ?>
                <?php } ?>
